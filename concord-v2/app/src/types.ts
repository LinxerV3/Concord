...
export interface UserDoc {
  ...
  /** preset theme id (string) or a custom theme object {vars} */
  theme?: any;
  /** persistent status that survives closing the app */
  statusMode?: StatusMode | null;
  /** user's own :shortcode: -> image url custom emojis */
...
export interface StatusMode {
  ...
  detail?: string;   // e.g. the class name, or free text
  emoji?: string;
}
...
export interface Message {
  ...
  tsMillis: number;
  pending?: boolean;
  /** emoji -> array of uids who reacted */
