...
export const PRESET_THEMES: Theme[] = [
  {
    ...
    vars: { bg0:"#0b0d14", bg1:"#12151f", bg2:"#161a26", bg3:"#1f2432", bg4:"#2b3142",
            txt:"#eef1f8", txt2:"#9aa3bd", txt3:"#5c6480", accent:"#7c6cff", accentH:"#9d90ff" },
  },
  {
    id: "cyber", name: "Cyber", emoji: "\ud83d\udda5\ufe0f",
    vars: { bg0:"#080b12", bg1:"#0e131c", bg2:"#121824", bg3:"#1a2130", bg4:"#252f42",
            txt:"#e6fbff", txt2:"#88b7c4", txt3:"#4f6b78", accent:"#00e5ff", accentH:"#5cf0ff" },
  },
  {
    id: "bloom", name: "Bloom", emoji: "\ud83c\udf38",
    vars: { bg0:"#120a16", bg1:"#1a0f20", bg2:"#20132a", bg3:"#2b1a38", bg4:"#3a2449",
            txt:"#fbe9ff", txt2:"#c79ad8", txt3:"#835f97", accent:"#ff5cc8", accentH:"#ff85d8" },
  },
  {
...
/* ---- Appearance settings (density + font scale + accent hue shift) ---- */
...
export function applyAppearance(a: Appearance = {}) {
  ...
  root.style.setProperty("--hue-shift", String(a.hue ?? 0) + "deg");
}
